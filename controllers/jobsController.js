...
const getAllJobs = async (req, res) => {
  ...
  // no await as just querying data first
...
const updateJob = async (req, res) => {
  ...
  console.log(`We are at update job controller`);
  ...
  // check permissions
  // if userID doesn't match then throws UnAuthenticatedError
  checkPermission(req.user, job.createdBy);

  // doesn't trigger hooks/methods
  // .save will trigger hooks in model
